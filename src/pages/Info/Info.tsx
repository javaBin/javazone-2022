    ...
    return (
        <>
            ...
            <Section color="pink" header={<h1>JavaZone 101 the who, what and where</h1>}>
                ...
                <p>
                    In 2021 due to COVID-19 we had our second virtual conference, with 7 parallal tracks. This year we are back to a physical conference at Oslo spektrum september 7-8th.
                </p>
                <p>
            ...
            <Section color="pink" header={<h1>Hands-on workshops</h1>}>
                <p>
                    Do you prefer practical tasks more than theory? Take part in one of our great workshops and boost your knowledge and skills. The workshops are included in your ticket, but we have a limited number of seats. More information, along with registration details will be made available in september.
                </p>
            </Section>
            ...
            <Section color="pink" header={<h1>Questions?</h1>}>
                ...
                <p>
                    We are looking forward to seeing you at JavaZone 2022!
                </p>
            </Section>
        </>
    )
