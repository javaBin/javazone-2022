...
const workshop = {
    ...
    description: 'We will continue the popular workshop concept with a range of sessions on Tuesday, December ' +
        '7th. The format for the workshops is in-depth, hands-on and interactive.'
};
