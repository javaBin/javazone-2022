...
export function VikingBanner(props: PageBannerProps) {
    ...
    return (
        <section className={styles.pageBanner}>
            <img className={styles.pageBannerImg} src={`/2022/images/${bannerSrc}`} alt="Page banner"/>
            <img className={cls1} src={`/2022/images/${eyes1}`} alt="Page banner"/>
            <img className={cls2} src={`/2022/images/${eyes2}`} alt="Page banner"/>
